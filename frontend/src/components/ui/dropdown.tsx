...
export function DropdownItem({
  ...
  let classes = clsx(
    ...
    // Focus
    'data-focus:bg-violet data-focus:text-violet-foreground',
    // Disabled state
...
export function DropdownHeading({
  ...
  return (
    <Headless.MenuHeading
      ...
      className={clsx(
        className,
        'col-span-full grid grid-cols-[1fr_auto] gap-x-12 px-3.5 pt-2 pb-1 text-sm/5 font-medium text-neutral-500 sm:px-3 sm:text-xs/5'
      )}
    />
  )
}
...
export function DropdownDescription({
  ...
  return (
    <Headless.Description
      ...
      className={clsx(
        className,
        'col-span-2 col-start-2 row-start-2 text-sm/5 text-neutral-500 group-data-focus:text-white sm:text-xs/5 forced-colors:group-data-focus:text-[HighlightText]'
      )}
    />
  )
}
